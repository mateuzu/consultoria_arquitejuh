    ...
    return (
        ...
        >
            <div className={`p-2 bg-BRANCO flex flex-col items-center relative`}>
                <span className="text-ROXO_NUANCE_1 text-center uppercase mt-5">Consultoria</span>
                <h5 className="mb-1 mt-2 text-4xl font-medium  text-ROXO_NUANCE_3">Simples</h5>
                <h5 className="text-sm font-medium text-ROXO_NUANCE_3">Para 1 ambiente</h5>
            </div>
            <div className="p-6 bg-BRANCO flex flex-col items-center">
                <p className="mb-4 text-xs text-center font-bold uppercase text-ROXO_NUANCE_3">
                    Indicado para quem quer dicas e sugestão para a decoração do ambiente.
                </p>
                <div className="w-full border-t border-ROXO_NUANCE_4 my-4"></div>
                <div className="flex flex-col items-center justify-center text-ROXO_NUANCE_3 min-h-[150px]">
                    <span className="text-xl font-normal uppercase">A partir de</span>
                    <div className="flex items-baseline space-x-1">
                        <span className="text-3xl font-semibold text-ROXO_NUANCE_3">R$</span>
                        <span className="text-5xl font-extrabold tracking-tight text-ROXO_NUANCE_3">749,99</span>
                    </div>
                    <span className="ms-1 text-sm font-normal text-ROXO_NUANCE_3">
                        por ambiente *
                    </span>
                </div>
            </div>
            <div className="bg-ROXO_NUANCE_4 p-6 flex flex-col items-center">
